...
from ObjectDetector import ObjectDetectorResult, BoundingBox

class ObjectTracker:

    def __init__(self, model_name='CSRT', do_timing=False):
...
class MultiObjectTracker:
    ...
    def initialize(self, image, bboxes):
        self.trackers = [ObjectTracker(model_name=self.model, do_timing=self.do_timing) for bbox in bboxes]
